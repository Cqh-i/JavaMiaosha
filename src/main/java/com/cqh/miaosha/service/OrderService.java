...
import com.cqh.miaosha.dao.OrderDao;
...
import com.cqh.miaosha.redis.OrderKey;
...
public class OrderService {
    ...
    public MiaoshaOrder getMiaoshaOrderByUserIdAndCoodsId_Cache(Long userId, Long goodsId) {
        // 1.先去缓存里面取得
        MiaoshaOrder morder = redisService.get(OrderKey.getMiaoshaOrderByUidAndGid, "" + userId + "_" + goodsId,
                MiaoshaOrder.class);
        return morder;
